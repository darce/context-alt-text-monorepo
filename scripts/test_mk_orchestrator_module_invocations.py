...
def test_handoff_integrity_make_target_uses_repo_local_guard() -> None:
    ...
    assert '-m agent_orchestrator_mcp.orchestration.handoff_integrity_guard' not in text
...
def test_remaining_mk_orchestrator_helpers_use_installed_modules() -> None:
    ...
    expected_snippets = (
        '-m agent_orchestrator_mcp.orchestration.handoff_guidance_summary',
        '-m agent_orchestrator_mcp.orchestration.review_dispatch',
        '-m agent_orchestrator_mcp.orchestration.review_runner run',
        '-m agent_orchestrator_mcp.orchestration.generate_lane_manifest',
        '-m agent_orchestrator_mcp.orchestration.bootstrap_lane',
        '-m agent_orchestrator_mcp.orchestration.lane_prompt',
        '-m agent_orchestrator_mcp.orchestration.lane_exec',
        '-m agent_orchestrator_mcp.orchestration.lane_result handoff',
        '-m agent_orchestrator_mcp.orchestration.dashboard_live',
        '-m agent_orchestrator_mcp.orchestration.dashboard_tui',
    )
