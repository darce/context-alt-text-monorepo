...
class LifecycleManager {
	...
	public function build_projection_schema_statements( string $prefix, string $charset_collate ): array {
		...
		$clusters_sql = "CREATE TABLE {$clusters_table} (
			...
			representative_quality double NULL,
			quality_components longtext NULL,
			representative_media_id bigint(20) unsigned DEFAULT NULL,
			undoable_merge_receipt_id varchar(64) NULL,
