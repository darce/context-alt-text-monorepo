...
def _review_guide_path(workspace_root: Path, review_kind: ReviewKind) -> str:
    ...
    return str(workspace_root / "docs" / "agentic" / "rules" / guide_name)
...
def _build_packet_for_decision(
    ...
    *,
    ...
    from agent_handoff_mcp.enums import ReviewScopeSource  # noqa: PLC0415
    from agent_handoff_mcp.slice_decision import extract_slice_label  # noqa: PLC0415
...
def get_latest_slice_review_packet_data(
    ...
    *,
    ...
    from agent_handoff_mcp.enums import ReviewKind  # noqa: PLC0415
    from agent_handoff_mcp.slice_decision import is_slice_complete_decision  # noqa: PLC0415
