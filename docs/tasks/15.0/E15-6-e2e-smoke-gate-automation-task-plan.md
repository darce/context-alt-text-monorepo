# E15-6. E2E Smoke Gate Automation (DEFERRED to E15.5)

> **Task Short ID**: E15-6
> **Status**: deferred -- owned by [E15.5. Demo Operational Hardening](../../epics/v0.4.1/demo-operational-hardening-epic.md)
> **Epic (source)**: [E15. Public Demo Launch Readiness](../../epics/v0.4.0/public-demo-launch-readiness-epic.md) Phase 5
> **Epic (owner)**: E15.5 Demo Operational Hardening
...
The MVP exit criterion for E15 is a **manual** WP -> backend -> recognition round-trip with a run log (see [E15-5](./E15-5-remote-e2e-verification-task-plan.md)). An automated smoke gate is the next increment after MVP: it prevents regressions across deploys rather than being necessary to ship the first demo.

Deferring the smoke gate to E15.5 keeps v0.4.0 shippable on a short timeline and puts the automation effort where it pays off -- after a real demo URL has existed for long enough that a regression story is plausible.

## Scope (to be refined in E15.5)
...
## Acceptance bar (when picked up under E15.5)
...
This file is intentionally a stub and NOT an active task plan. Do not start implementation against this plan while it remains deferred. When E15.5 picks it up, re-open this file and expand into full slices.
