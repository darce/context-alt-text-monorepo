...
def main() -> int:
    ...
    from agent_handoff_mcp import get_handoff_state, handoff_close_check  # noqa: PLC0415
    from agent_handoff_mcp.enums import ReviewKind, ReviewScopeSource  # noqa: PLC0415
    from agent_handoff_mcp.review_findings import get_review_findings_summary  # noqa: PLC0415
