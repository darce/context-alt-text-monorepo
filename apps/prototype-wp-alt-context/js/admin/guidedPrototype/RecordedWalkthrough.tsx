        ...
        >
          ...
          <div className="acx-guided-page__scenario">
            ...
            <div className="acx-guided-page__context">
              ...
              <p>
                The starting “before” text was generated by{' '}
                <a href="https://alttext.ai/" target="_blank" rel="noreferrer">
                  AltText.ai (opens in a new window)
                </a>
                {' '}in its free web demo on 9 September 2026, with no names or keywords supplied.
                It described both people without naming them. This is one recorded sample, not a benchmark; its wording is unedited.
              </p>
              <p>
