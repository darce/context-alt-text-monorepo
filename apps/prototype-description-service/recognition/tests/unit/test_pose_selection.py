...
def test_get_pose_bucket_logs(caplog):
    # Scope caplog to the representative_selector namespace so it overrides the
    ...
    caplog.set_level(logging.DEBUG, logger="recognition.application.persistence.representative_selector")
