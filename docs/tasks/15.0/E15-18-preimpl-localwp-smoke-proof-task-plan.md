...
- [x] Loaded the PREIMPL spec, E15-14 related plan, LocalWP wrapper tests, and handoff state before editing. *Anchored by the Slice 1/2 proof notes above and `scripts/test_localwp_batch_run_smoke.py`.*
