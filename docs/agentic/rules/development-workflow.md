...
- After archiving a merged task, regenerate `CURRENT_TASK.md` in the same cleanup slice.
...
8. Regenerate `CURRENT_TASK.md` after merge/archive (mandatory). If a completed task still appears, close or defer its remaining findings first.
