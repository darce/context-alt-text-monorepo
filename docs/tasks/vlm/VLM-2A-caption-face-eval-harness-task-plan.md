...
- Contract/fixture verification:
  - `cd apps/prototype-description-service && uv run python -m scripts.eval_harness.cli score --run-record <baseline record> --check-determinism` — re-score committed baseline; deterministic sections diff-clean.
- Manual verification:
