...
``agent_orchestrator_mcp.api`` at module load via
...
if TYPE_CHECKING:
    from agent_handoff_mcp.dashboard_rendering import DashboardContext, DashboardSection
...
def lane_worker_extension(ctx: DashboardContext) -> list[DashboardSection]:
    ...
    without triggering an early circular import of agent_handoff_mcp symbols.
    """
    from agent_handoff_mcp.dashboard_rendering import DashboardSection  # noqa: PLC0415
