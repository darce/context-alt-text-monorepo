...
ABSOLUTE_NODEID_FLOOR = 2051  # synced by --record-baseline; growth requires re-record
...
_EMBEDDED_NODEID_BASELINE: frozenset[str] = frozenset({
    ...
    'test_license_policy.py::TestF13CatalogSeparatorTags::test_cross_family_tags_stay_deny[ppyolo_voc]',
