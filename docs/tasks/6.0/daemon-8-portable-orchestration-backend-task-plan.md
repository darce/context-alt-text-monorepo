...
| File                                                           | Note                                                                                                                                                                         |
| -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `scripts/mcp/lane_exec.py`                                     | Primary consumer of backend dispatch. Contains `BACKEND_CHOICES` (line 38), `_validate_backend` (line 205), `_run_subagent` (line 308), and the `codex-cli` subprocess path. |
...
| `scripts/mcp/lane_prompt.py`                                   | Prompt rendering (shared across backends, unchanged).                                                                                                                        |
