...
- [ ] Local and remote reset docs point to each other and describe when each tool should be used.
- [ ] At least one plugin-side service-mode smoke is captured after OCI dev reset.
- [ ] At least one local-mode smoke is captured after local reset.
