...
def make_repo() -> NullClusterRepository:
    """Create a mature no-op repository for gate orchestration tests."""
    return NullClusterRepository(labeled_count=10)
