...
- [x] Automated tests cover the reported Laura/Talvi/Jen-style scenarios as suggestion CTAs (including low-confidence where applicable) instead of persistent "Name this person".
