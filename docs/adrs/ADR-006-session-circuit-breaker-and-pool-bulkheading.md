...
The assessment at `docs/assessments/infailed-sql-transaction-investigation-2026-04-09.md` shows the immediate bug is a double-owned SQLAlchemy lifecycle, but it also leaves two broader resilience questions open:
