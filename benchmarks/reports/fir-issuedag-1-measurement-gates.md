...
| COCO licence and keypoint counts | 69.0% NC, 26.1% usable, 30,836 images, 16,513 with a person, 33,193 head-bearing instances, 48.6% keypoint coverage have no persisted script and no pinned annotation-JSON revision | Replication script + pinned revision + BY-SA policy call (D-05 / T-07). See also `openimages-occlusion-MEASUREMENTS.md`. | The Open Images first-party counts in that measurements file |
