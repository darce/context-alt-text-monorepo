...
ABSOLUTE_NODEID_FLOOR = 2256  # synced by --record-baseline; growth requires re-record
...
_EMBEDDED_NODEID_BASELINE: frozenset[str] = frozenset({
    ...
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[aabuffalo_fp16-buffalo_fp16]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[aabuffalo_int8-buffalo_int8]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[aabuffalo_l-buffalo_l]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[aabuffalo_l2-buffalo_l2]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[aabuffalo_onnx-buffalo_onnx]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[aabuffalo_pt-buffalo_pt]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[aabuffalo_s-buffalo_s]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[aabuffalo_sc-buffalo_sc]',
    ...
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[aayolo_nas_s-yolo_nas_s]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[mybuffalo_l-buffalo_l]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[xantelope_v2-antelope_v2]',
    'test_license_policy.py::TestF15JunkMultiSegmentNcFloor::test_junk_multi_seg_nc_floor_denies[xbuffalo_l-buffalo_l]',
...
MUTATIONS: list[Mutation] = [
    ...
    Mutation(
        ...
        expected_victims=(
            ...
            "test_red_proof_total_ascii_punct_fold_neuter",
            "test_red_proof_unofficial_separator_charset_neuter",
            # Wave F15: steal / 4-char head / mid-exception pins.
            "test_four_char_head_suffix_tolerant_denies",
            "test_yolobuffalo_l_is_yolo_head_plus_known_rem",
            "test_mid_exception_unknown_rem_denies",
            "test_red_proof_four_char_suffix_tolerant_neuter",
