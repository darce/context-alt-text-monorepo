...
describe("MediaList", () => {
    it("renders empty state when no items provided", () => {
        render(<MediaList items={[]} selectedIds={new Set()} onToggleSelect={vi.fn()} viewMode="list" />);
    ...
    it("renders list view with items", () => {
        render(<MediaList items={mockItems} selectedIds={new Set()} onToggleSelect={vi.fn()} viewMode="list" />);
    ...
    it("renders grid view with items", () => {
        render(<MediaList items={mockItems} selectedIds={new Set()} onToggleSelect={vi.fn()} viewMode="grid" />);
    ...
    it("displays correct status chips", () => {
        ...
        render(
            <MediaList items={itemsWithStatuses} selectedIds={new Set()} onToggleSelect={vi.fn()} viewMode="list" />,
        );
    ...
    it("handles selection via checkbox", async () => {
        ...
        render(<MediaList items={mockItems} selectedIds={new Set()} onToggleSelect={onToggleSelect} viewMode="list" />);
    ...
    it("displays selected state correctly", () => {
        render(<MediaList items={mockItems} selectedIds={new Set(["1"])} onToggleSelect={vi.fn()} viewMode="list" />);
    ...
    it("renders recognition metadata when provided", () => {
        ...
        render(
            <MediaList items={itemsWithRecognition} selectedIds={new Set()} onToggleSelect={vi.fn()} viewMode="list" />,
        );
    ...
    it("passes accessibility audit", async () => {
        const { container } = render(
            <MediaList items={mockItems} selectedIds={new Set()} onToggleSelect={vi.fn()} viewMode="list" />,
        );
