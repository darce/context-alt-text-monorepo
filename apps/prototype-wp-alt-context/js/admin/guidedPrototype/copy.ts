...
export const GUIDED_COPY = {
  ...
  "page.scope": "This walkthrough uses recorded face suggestions and altcontext.com drafts. Your choices change only the demo copy in this tab and reset when you reload.",
  ...
  "draft.origin_saved": "Recorded altcontext.com draft from 9 September 2026, using the supplied page context and your selected names.",
  ...
  "live.request_confirmed": "This sends a live description request for the example photo to the configured altcontext.com service. See Request details before starting.",
  ...
  "live.budget_disclosed": "The service disclosed {generation} of generation time. This page will wait up to {deadline}, which may add service warm-up and a short local slack.",
