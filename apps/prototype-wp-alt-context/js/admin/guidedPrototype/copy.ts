...
export const GUIDED_COPY = {
  ...
  "roster.explainer.body": "The saved people and reference photos below belong to this example. Compare the available references before deciding which names, if any, belong in the alt text.",
  "roster.explainer.purpose": "Your choice is an editorial inclusion decision for this demo. Leaving someone unnamed is valid; it does not change a server roster or verify an identity.",
  "faces.group_title": "People recognised in this photo",
  "context.photo.credit_label": "Photo credit",
  "context.photo.alttextai_title": "AltText.ai comparison caption",
  "context.photo.altcontext_title": "AltContext caption, with the people roster set up",
  ...
  "names.pending": "Choose an option for this person.",
  ...
  "draft.blocked": "Choose a name option for both people to load the sample draft.",
  ...
  "notes.recorded_public": "Recorded recognition keeps the core walkthrough repeatable so you can review the same example every time.",
