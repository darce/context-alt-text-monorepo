...
- [x] Dual sampling frames + dual label-map frames side-by-side; **`frame_e2e` pinned as the sole CONFIRMATORY sampling frame** (primary endpoint uses `e2e`; `e2e` recall ≤ `native` recall by construction)
