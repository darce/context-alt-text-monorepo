...
- **File ownership (hard boundary).** This lane edits
  ...
  `:353`, Lane B row of `#### §6e ownership table` at `:370` — real path
...
- **Prompt text is out of scope.** The weave-instruction half of F1 has nowhere
  ...
  `scene/prompts/caption_system.py` (DEPICT-0 `:433-436`: *"A future promotion
...
3. **F1 (b) production-weave** remains **OUT of this wave and unowned** after
   ...
   of `PRODUCTION_PROMPT` (DEPICT-0 `:433-436`: *"A future promotion replaces
