...
- prompt variant: `v2` pipeline: dual_length
- latency: per-image wall-clock p50 3.555s p95 10.164s (37 timed) · model calls/image: 2.0 (total 74)

## Caption metrics (deterministic tier)

- insertion rate: 1.000
- name precision: 0.900 (wrong-name images: 4, rate: 0.108)
- Must-Right failed images (hard gate): 0 (rubric-defined images: 37)
- policy violations: 0
- mean gated score: 0.892

## Quality axes (short surface, report-only signals)

- meta-framing images: 1
- mean context duplication: 0.189
...
- images with long: 37
- insertion rate: 1.000 name precision: 0.900
- wrong-name images: 4
- mean gated score: 0.892
- mean word count: 82.2
- meta-framing images: 3
- mean context duplication: 0.115
- name front-loaded rate: 0.971
- sentence band [2, 8] ok rate: 1.000

## Context-distractor resistance

- injected: 37 taken: 4 resistance: 0.892
