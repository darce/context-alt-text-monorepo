...
For the E17-13 cleanup path, verify `workbay-handoff-mcp` and `workbay-orchestrator-mcp` as packaged standalone installs, not via worktree-local package test targets.
