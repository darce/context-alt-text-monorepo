    ...
    try:
        ...
        try:
            ...
            if _reflect_log.exists():
                _total_lines = sum(1 for _l in _reflect_log.read_text(encoding="utf-8").splitlines() if _l.strip())
                _processed = 0
                ...
                if _offset_file.exists():
                    try:
                        ...
                        _processed = _json.loads(_offset_file.read_text(encoding="utf-8")).get(
