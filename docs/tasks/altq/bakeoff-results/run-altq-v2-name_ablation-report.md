...
- prompt variant: `v2`
- latency: per-image wall-clock p50 2.658s p95 9.203s (37 timed) · model calls/image: 1.0 (total 37)
...
- mean context duplication: 0.161
- name front-loaded rate: 0.000
- sentence band [1, 4] ok rate: 0.946
