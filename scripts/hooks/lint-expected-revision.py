...
AHMCP-21 / Layer 3 of the expected_revision bug class eradication. The
...
from shell heredocs by AHMCP-20) and fails when any ``set_handoff_state``
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        ...
        "  AHMCP-21 / expected_revision bug class eradication.",
        file=sys.stderr,
    )
    return 1
