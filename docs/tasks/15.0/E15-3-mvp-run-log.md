...
Status: template for operator capture
Task: E15-3
...
## Settings / Provisioning Evidence

- `/settings/test` timestamp:
- Probe result:
- Outcome taxonomy / response summary:
- Notes:

## Manual Round-Trip Summary

- Scan timestamp:
- Media count submitted:
- Observed latency:
- Errors / warnings:
...
## Local-Read Fallback Evidence

- RFC5737 backend URL used:
- Cached-state render observed:
- Sync-status text observed:
- Screenshot / transcript path:
- Production backend URL restored at:

## Hotfix / Rollback Procedure Evidence
