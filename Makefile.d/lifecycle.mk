...
#
# GPUUX-1-REPO-BR-02 / VMREAP-1-BR-04: default the bootstrap so linked
# worktrees receive the gitignored overlay (Makefile.d, hooks, lifecycle
# runner) and never get a symlink-dereferencing copy of node_modules/vendor.
LIFECYCLE_WORKTREE_BOOTSTRAP ?= $(LIFECYCLE_PYTHON) $(abspath $(LIFECYCLE_MK_DIR)../scripts/workstate/provision_lane_worktree.py) --worktree .
