"""Tests for scripts/hooks/lint-dashboard-txt.py (E17-9 Slice 4).

The guard forbids `DASHBOARD.md` from re-appearing in tracked non-archive
paths after the E17-7 `DASHBOARD.md → DASHBOARD.txt` rename. It is
...
def test_is_excluded_recognizes_archive_and_fixture_patterns() -> None:
    ...
    assert not module.is_excluded(Path("docs/tasks/17.0/E17-10-future-plan.md"))
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "packages/agent-handoff-mcp/README.md",
    ],
)
