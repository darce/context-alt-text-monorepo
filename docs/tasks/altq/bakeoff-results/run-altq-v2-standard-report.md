...
- prompt variant: `v2`
- latency: per-image wall-clock p50 2.572s p95 9.162s (37 timed) · model calls/image: 1.0 (total 37)

## Caption metrics (deterministic tier)

- insertion rate: 0.972
- name precision: 1.000 (wrong-name images: 0, rate: 0.000)
- Must-Right failed images (hard gate): 1 (rubric-defined images: 37)
- policy violations: 0
- mean gated score: 0.973

## Quality axes (short surface, report-only signals)

- meta-framing images: 2
- mean context duplication: 0.199
