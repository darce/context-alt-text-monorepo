...
- **Command**: `VIRTUAL_ENV= uv run --locked --extra dev python -m pytest recognition/tests/unit/test_scan_queue_correlation.py recognition/tests/unit/test_scan_handler_correlation.py recognition/tests/unit/test_scan_queue_service.py recognition/tests/api/test_correlation.py -v`
