...
- latency: per-image wall-clock p50 3.539s p95 10.084s (37 timed) · model calls/image: 2.0 (total 74)
...
- mean context duplication: 0.219
...
- images with long: 37
- insertion rate: 1.000 name precision: 1.000
- wrong-name images: 0
- mean gated score: 1.000
- mean word count: 78.9
- meta-framing images: 5
- mean context duplication: 0.117
