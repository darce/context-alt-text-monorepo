...
| `composer cs-check`                                                                                            | fail (invocation fixed; reports real PHPCS violations) |

## Audit Command Contract (Updated 2026-02-09)

Run from:

- `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context`

Required branch-review gate commands:

1. `composer cs-check` (targets: `src`, `tests`, `alt-context.php`)
2. `composer test`
3. `npm run typecheck`
...
| --- | -------- | ----------- | -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| H-1 | HIGH     | GAP         | PHP code-style gate was non-runnable via composer script (resolved 2026-02-09) | `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/composer.json:32` (`cs-check` now targets `src tests alt-context.php`)                                                                                                                                                                                                                                    |
| M-1 | MEDIUM   | DEAD_CODE   | Frontend service path appears unused/placeholder                     | `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/src/class-alt-context.php:16`, `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/src/class-alt-context.php:35`, removed file `apps/prototype-wp-alt-context/src/frontend/class-frontend.php`                               |
...
| M-4 | MEDIUM   | DEAD_CODE   | Deprecated compatibility re-export appears unused outside tests      | Removed file `apps/prototype-wp-alt-context/js/admin/pages/workbench/IdentityClusterList.tsx`                                                                                                                                                                                                                                                                                          |
| M-5 | MEDIUM   | DEAD_CODE   | Tracked debug artifacts should not ship in deployment-focused branch | Removed in this branch: `apps/prototype-wp-alt-context/test_output.txt`, `apps/prototype-wp-alt-context/test_output_debug.txt`                                                                                                                                                                                                                                                          |
...
1. Validate whether frontend placeholder surface should be wired or removed.
...
| `(deleted)`                                                                                                                            | n/a           | Removed placeholder `apps/prototype-wp-alt-context/src/frontend/class-frontend.php` after consumer audit.         |
...
| `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/src/api/class-recognition-controller.php`         | 148, 238, 618, 756 | Removed `training-stage` and `recover-orphans` route/proxy surfaces after compatibility checks passed. |
| `(deleted)`                                                                                                                            | n/a           | Removed compatibility re-export `apps/prototype-wp-alt-context/js/admin/pages/workbench/IdentityClusterList.tsx`. |
...
| `(deleted)`                                                                                                                            | n/a           | Removed tracked debug artifact `apps/prototype-wp-alt-context/test_output.txt` from deploy-focused branch.        |
| `(deleted)`                                                                                                                            | n/a           | Removed tracked debug artifact `apps/prototype-wp-alt-context/test_output_debug.txt` from deploy-focused branch.  |

## Public API and Compatibility Notes

1. `AltContextAdmin.endpoints` no longer includes `recognitionTrainingStage` after zero-consumer audit.
2. REST routes `/acx/v1/recognition/training-stage` and `/acx/v1/recognition/clusters/recover-orphans` were removed after `rg` consumer checks plus passing PHP/TS test gates.
3. Compatibility re-export `apps/prototype-wp-alt-context/js/admin/pages/workbench/IdentityClusterList.tsx` was removed after import audit confirmed no consumers.
4. `AltContextAdmin.endpoints` no longer includes `recognitionClustersEvents`; `/acx/v1/recognition/clusters/events` and the orphaned `useClusterEvents` hook were removed after consumer audit.
...
- `apps/prototype-wp-alt-context/src/frontend/class-frontend.php` (removed 2026-02-09)
...
| ID     | Severity | Category    | Finding                                                                                                                                                                                                                                                                                                                                                                                           | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Recommended Action                                                                                                                                                                                                                                                       |
| ------ | -------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | --------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| AFS-M1 | MEDIUM   | DEAD_CODE   | Frontend service remains instantiated/injected but has no runtime behavior or init wiring.                                                                                                                                                                                                                                                                                                        | `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/alt-context.php:107`, `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/src/class-alt-context.php:16`, `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/src/class-alt-context.php:35`, removed file `apps/prototype-wp-alt-context/src/frontend/class-frontend.php`                                                                                                       | Either remove `Frontend` from construction/wiring or implement and initialize explicit frontend responsibilities in `AltContext::init()`.                                                                                                                                |
| AFS-M2 | MEDIUM   | DEAD_CODE   | `recover-orphans` route appears orphaned from the admin runtime surface.                                                                                                                                                                                                                                                                                                                          | `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/src/api/class-recognition-controller.php:238`, `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/src/api/class-recognition-controller.php:618`; `rg "recover-orphans" /Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/js/admin` -> no matches                                    | Removed route and proxy method after consumer audit confirmed no runtime callers.                                                                                                                              |
| AFS-M3 | MEDIUM   | GAP         | Cluster-events real-time path is incomplete: backend emits heartbeat pings, but frontend subscription hook is not wired into runtime components.                                                                                                                                                                                                                                                  | `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/src/api/class-recognition-controller.php:123`, removed file `apps/prototype-wp-alt-context/js/admin/hooks/useClusterEvents.ts`, `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/js/admin/pages/workbench/__tests__/IdentityClusterList.test.tsx:235` | Removed cluster-events endpoint key/route and orphaned hook after confirming no runtime consumers.                                                                                                                       |
...
| AFS-L2 | LOW      | GAP         | Route-level tests do not currently cover cluster-events stream, include-debug parsing behavior, or explicit absence assertions for removed routes.                                                                                                                                                                                                                                                | `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/tests/Unit/RecognitionControllerTest.php:12`, `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/tests/Unit/ProxyRequestTest.php:13`; `rg "stream_cluster_events|include_debug|training-stage|recover-orphans" /Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/tests` -> no matches | Add focused unit tests for cluster-events and include-debug parsing, plus explicit tests confirming removed route surfaces stay absent. |
...
| ID    | Severity | Category    | Finding                                                                                                                              | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                | Recommended Action                                                                                                                                   |
| ----- | -------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| HK-M1 | MEDIUM   | DEAD_CODE   | `useClusterEvents` remains effectively orphaned in runtime code paths.                                                               | Removed file `apps/prototype-wp-alt-context/js/admin/hooks/useClusterEvents.ts`; `rg "useClusterEvents" /Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/js/admin` now returns no runtime call sites                                                            | Removed orphaned hook and matching endpoint key/route after consumer audit.                                |
...
| HK-L2 | LOW      | GAP         | Hook test coverage does not currently exercise unsupported-browser/storage-failure paths for deployment hardening.                   | `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/js/admin/hooks/__tests__/useJobCoordination.test.ts:19`; `/Users/daniel/Development/context-alt-text-monorepo/apps/prototype-wp-alt-context/js/admin/hooks/__tests__/useJobPersistence.test.ts:21` | Add failure-path tests for missing `BroadcastChannel`, missing `crypto.randomUUID`, and storage write failures. |
...
- [x] Decide keep/remove strategy for frontend placeholder surface.
- [x] Confirm consumer status for `recognitionTrainingStage` and `/recognition/training-stage`.
- [x] Confirm consumer status for `/recognition/clusters/recover-orphans`.
- [x] Remove unused surfaces or add explicit deprecation records.
- [x] Resolve `AFS-M1`: remove unused frontend dependency wiring or implement and initialize it.
- [x] Resolve `AFS-M2`: deprecate/remove `recover-orphans` route surface if consumer audit stays empty.
- [x] Resolve `M-2`: remove training-stage endpoint key/route/style surface after zero-consumer audit.
...
- [x] Remove tracked debug artifacts (`test_output.txt`, `test_output_debug.txt`) or relocate them outside tracked deploy paths.
