...
export const DashboardPage = (): React.JSX.Element => {
	return (
		<section className="alt-context-dashboard__shell" aria-labelledby="alt-context-dashboard-title">
			<header className="alt-context-dashboard__hero">
				<p className="alt-context-dashboard__eyebrow">
					{__('Alt Context', 'alt-context')}
				</p>
				<h1 id="alt-context-dashboard-title" className="alt-context-dashboard__title">
					{__('Alt Context Dashboard', 'alt-context')}
				</h1>
				<p className="alt-context-dashboard__subtitle">
					{__(
			...
			<div className="alt-context-dashboard__panels">
				<section className="alt-context-dashboard__panel">
