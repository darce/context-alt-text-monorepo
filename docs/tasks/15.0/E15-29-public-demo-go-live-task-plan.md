...
- Run the walkthrough: `make demo-walkthrough-proof` (or manual `walkthrough-runbook.md`) against the live URL; needs `ACX_E2E_WP_ADMIN_USER`/`ACX_E2E_WP_ADMIN_PASS`. Artifacts land under `apps/prototype-wp-alt-context/local/playwright/E15-29/evidence/`.
