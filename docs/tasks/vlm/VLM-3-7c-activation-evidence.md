...
- Instance `acx-gpu-burst` = `ocid1.instance.oc1.iad.anuwcljr2mcagaqcki4d2szgsymtr4ucpc3dsqzfsvwoj2gtemrjx2dlammq`
  (VM.GPU.A10.1, golden image `acx-gpu-qwen3vl30b-golden`, private IP `10.0.1.36`,
...
1. **Endpoint URL**: `ACX_GPU_ENDPOINT_URL=http://localhost:18000` (loopback →
   SSH tunnel `localhost:18000 → acx-backend → 10.0.1.36:8000`); loopback/private
