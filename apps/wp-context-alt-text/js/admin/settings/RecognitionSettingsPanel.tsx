...
export const RecognitionSettingsPanel = ({
    ...
    const handleFieldChange = React.useCallback(<K extends keyof RecognitionSettingsPayload>(key: K, value: RecognitionSettingsPayload[K]) => {
        setForm((current) => {
    ...
    const handleSubmit = React.useCallback((event: React.FormEvent<HTMLFormElement>) => {
        ...
        const persist = async () => {
            try {
                ...
                const message =
                    error instanceof Error ? error.message : __("An unexpected error occurred.", "context-alt-text");
    ...
    const handleTestConnection = React.useCallback(() => {
        ...
        const runTest = async () => {
            try {
                ...
                if (!response.ok) {
                    throw new Error(payload?.message ?? __("Recognition service did not respond successfully.", "context-alt-text"));
                }
                ...
                const message =
                    error instanceof Error
                        ? error.message
                        : __("Recognition service test failed.", "context-alt-text");
                setLastTestResult({
                    status: "error",
                    message,
                    timestamp: Date.now(),
    ...
    return (
        <div className="cat-recognition-settings">
            <header className="cat-recognition-settings__header">
                ...
                <p>
                    {__("Configure how Context Alt Text connects to the external recognition service.", "context-alt-text")}
                </p>
            </header>
            ...
            <form className="cat-recognition-settings__form" onSubmit={handleSubmit}>
                <table className="form-table" role="presentation">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <label className="cat-recognition-settings__toggle">
                                    ...
                                    />
                                    <span>{__("Enable to expose recognition-powered workflows in the admin UI.", "context-alt-text")}</span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <p className="description">
                                    {__("All API requests will be issued relative to this base URL.", "context-alt-text")}
                                </p>
                                {errors.baseUrl && (
                        ...
                        <tr>
                            <th scope="row">
                                <label htmlFor="cat-recognition-api-key">
                                    {__("API key", "context-alt-text")}
                                </label>
                            </th>
                            <td>
                                <input
                                ...
                                />
                                <p className="description">
                                    {__("Optional bearer token sent with each recognition request.", "context-alt-text")}
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                />
                                <p className="description">
                                    {__("Specify a target model/profile identifier when supported by the service.", "context-alt-text")}
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                />
                                <p className="description">
                                    {__("Maximum duration to wait for responses before aborting the request.", "context-alt-text")}
                                </p>
                                {errors.timeoutMs && (
                                    <p className="cat-recognition-settings__error" role="alert">
                                        {errors.timeoutMs}
