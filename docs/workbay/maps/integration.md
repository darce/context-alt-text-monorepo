...
| -------- | -------------------------------------------------- | ----------------------------- |
| 1        | `docs/workbay/contracts/clustering-api.md`         | WP REST -> FastAPI endpoints  |
| 2        | `docs/workbay/contracts/recognition-clustering.md` | FastAPI API spec              |
| 3        | `docs/workbay/contracts/curation-sync-api.md`      | Outbox replay contract        |
| 4        | `docs/workbay/contracts/cluster-snapshot-api.md`   | Snapshot pull contract        |
| 5        | `docs/workbay/contracts/security.md`               | Auth, tenant isolation        |
| 6        | `packages/shared-contracts/schemas/`               | JSON Schema definitions       |
| 7        | `docs/workbay/diagrams/system-overview.mmd`        | High-level architecture       |
...
1. **Define contract** in `docs/workbay/contracts/`
...
2. Update contract markdown in `docs/workbay/contracts/`
