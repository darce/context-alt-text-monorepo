...
| [fir-localwp-512d-implementation-roadmap-2026-09-19.md](fir-localwp-512d-implementation-roadmap-2026-09-19.md) | **Next-session FIR kickoff:** LocalWP + remote 512D, detector-first comparison, corpus populations/additions, human gates and bounded junior dispatch | Consolidated execution roadmap; implementation pending |
| [fir-occlusion-robust-recognition-roadmap-2026-09-11.md](fir-occlusion-robust-recognition-roadmap-2026-09-11.md) | Open-set gate contract (FNIR@FPIR, T-14 union adjudication), alignment-vs-embedder attribution, inference-only occlusion robustness, and the face_pipeline vs buffalo_l head-to-head on acx-dev-fir — Phases A–D under E22 | **Active (2026-09-11) — FIR re-plan** |
...
| [roadmap-pg19-upgrade.md](roadmap-pg19-upgrade.md) | PostgreSQL 17 → 19 upgrade evaluation (beta 3 ingest, incompatibility checklist, codemap impact map, video/planned-feature fit, canon assessment) — verdict: skip 18, one hop at GA on triggers | **Technical roadmap (2026-09-16)** |
| [roadmap-pg18-upgrade.md](roadmap-pg18-upgrade.md) | PostgreSQL 17 → 18 evaluation (v0.1)                                                            | Superseded by pg19 roadmap    |
