...
- score manifest_sha256: `08751e69bf4d6bb4d4303f0bc7c38758f1f6fdaa60253828b7101ce5c2306d97` (matches fetch: True)
...
- insertion rate: 0.888
- name precision: 0.685 (wrong-name images: 203, rate: 0.317)
...
- title hallucinated-name images: 24 (Audrey Hepburn, Bad Bunny, Bea, Bill Murray, Elizabeth Taylor, Erika, Faith Coggin, Faith Windebank, Ivy Bloom, Rachel Rabbit White)

## Long surface (alt_text_long)

- images with long: 640
- insertion rate: 0.921 name precision: 0.635
- wrong-name images: 262
- mean gated score: 0.558
- mean word count: 54.6
- meta-framing images: 72
- mean context duplication: 0.009
- name front-loaded rate: 0.903
- sentence band [2, 8] ok rate: 0.991

## Face detection (identity-agnostic)

- precision: null recall: 0.000 (tp=0 fp=0 fn=575)

## Face identification (named assertions)

- micro precision: null recall: 0.000
- macro precision: null recall: 0.000
- true rejections (strangers): 19
...
- Talvi Faustmann: precision=null recall=0.000 (tp=0 fp=0 fn=18)
