...
| R4-01 | `fix(docs): UXW2-5-R4-01 strip dead SHAs from r3 report` | gate loop + `grep -cE '\b[0-9a-f]{40}\b'` | `DEAD 0000000000000000000000000000000000000000` | loop silent; `grep -c` = `0` |
