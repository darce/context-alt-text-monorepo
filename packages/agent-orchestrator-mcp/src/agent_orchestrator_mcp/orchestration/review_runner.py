...
from agent_orchestrator_mcp.orchestration._env import WORKER_REASONING_EFFORT_CHOICES, apply_backend_runtime_hints
from agent_orchestrator_mcp.orchestration.backend_registry import (
    get_adapter,
    get_backend_choices,
    validate_backend,
)
...
def _resolve_review_scope(
    *,
    ...
    from agent_handoff_mcp.enums import ReviewKind, ReviewScopeSource  # noqa: PLC0415
...
def run_review(
    *,
    ...
    if orchestrator_root is not None:
        from agent_orchestrator_mcp.orchestration._env import pythonpath_env
