/**
 * E21-5 Slice 1b ② — card-local click-to-original lightbox.
...
export interface ReviewCardLightboxProps {
  open: boolean;
...
export const ReviewCardLightbox = ({
  open,
  onOpenChange,
  mediaUrl,
  bbox,
  label,
}: ReviewCardLightboxProps): React.JSX.Element => {
