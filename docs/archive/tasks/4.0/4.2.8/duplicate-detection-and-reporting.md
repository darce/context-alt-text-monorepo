...
1. `d43ccfb3` cluster created with Lindsay Blair from `6694` + `6692`
2. Lindsay Blair from `6695` (duplicate of 6694) tries to join via RepresentativeDiscovery
...
- 6692 is a **different photo** of Lindsay Blair → its embedding differs
