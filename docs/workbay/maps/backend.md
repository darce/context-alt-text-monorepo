...
| 6        | `docs/workbay/contracts/recognition-clustering.md`                                | API contract specification                          |
| 7        | `docs/workbay/contracts/curation-sync-api.md`                                     | Outbox replay contract                              |
...
For backend tooling that writes through the installed `workbay-handoff-mcp`, resolve task context in this order only:
